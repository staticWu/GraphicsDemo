...
struct xCircleData
{
	...
	constexpr xCircleData(const QPointF& p1, const QPointF& p2);
...
struct xArcData
{
	...
	constexpr qreal spanAngle() const noexcept { return alen; }
	constexpr inline void setSpanAngle(qreal alength);
	constexpr QPointF pt1() const noexcept { return p1; }
	constexpr QPointF pt2() const noexcept { return p2; }
	constexpr QPointF pt3() const noexcept { return p3; }
	constexpr inline void translate(const QPointF& p) noexcept;
...
constexpr inline xCircleData::xCircleData(const QPointF& center, const QPointF& p2)
	:c(center)
{
	r = qAbs(Distance(center,p2));
}
...
inline constexpr void xArcData::setSpanAngle(qreal alength)
{
